...
namespace LandslideMonitor.Migrations
{
    ...
    [Migration("20260626212900_fixFksensordataandauditlog")]
    partial class fixFksensordataandauditlog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LandslideMonitor.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("LandslideMonitor.Models.SensorData", b =>
                {
                    b.HasOne("LandslideMonitor.Models.Device", null)
                        .WithMany()
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
